...
export default class SwayWSS extends GObject.Object {
    static instance: SwayWSS

    static get_default() {
        if (!this.instance)
            this.instance = new SwayWSS()
    ...
    // Just return the workspaces.
    @property()
    get wss () { return this.#wss } 
    
    // Return Workspace ID, Return id
    @property(Number)
    get focused () { 
